...
CalculateRollingSD <- function(df, i, j) {
       ...
       #s <- sd(df$GDPGrowth[df$Year <= i & df$Country == j] & df$Year >= (i-10))
...
setwd("c:/Users/Matthew/OneDrive/E-107/Final Project/DATA/")
...
df_GrowthGDP <- read_csv("GDPGrowth2.csv")
...
#df_Fitch <- read_csv("df_FitchImputed.csv")
