...
Regulatory Quality: Percentile Rank, RQ.PER.RNK
	WorldBank
BroadMoney	Measure of total money supply in an economy	WorldBank
RollGenGovDeficit	3 year rolling average of the Central Governments budgetary Surplus/Deficit.	Worldbank/OECD
RollMeanChangeCPI	3 year rolling average of the consumer price index measure of inflation	Worldbank
WorldGDPRank	The rank of world GDP in USD	Worldbank
WorldGDPLog	Natural log of the rank of world GDP in USD	Worldbank
NonManMercExports	This is a measure of non-commodity exports. 
I calculated it by:
(1 - Manufactures exports (% of merchandise exports) * Merchandise exports (current US$) / GDP	Worldbank
RollNetForeignAssetsGDP	3 year rolling average of the ratio of net foreign assets to GDP 	Worldbank
RollCABFDI	3 year rolling average of the Sovereign Current Account Balance plus foreign direct investment	Worldbank/OECD
ReservesMonthsImports	Currency reserves expressed in months of imports	Worldbank
RollInterestPaymentsRevenue	3 year rolling average of the ratio of interest payments to government revenue	IMF/OECD
GDPGrowth	Real GDP growth	IMF
RealInterestRate	The data for interest rate payments is not freely provided for the high income nations. As a proxy I included the real interest rate.  This is the interest rate accounting for inflation and thus an indicator for risk. Logically, this would be related to the cost of financing for a government.	IMF
Default	If the country has defaulted in the last 25 years	Wikipedia
Defaulted	25 - the number of years since a default (0) if no default	Wikipedia
ReserveCurrrency	A categorical variable of the reserve qualities of the local currency. 3 = High, 2=Med, 1=Low, 0 = None	BIS bis.org

SDGDP	10 year trailing standard deviation of GDP growth	IMF
...
Thank you to the following organisations as we read in the data and wrangle it below
*The World Bank: Data
*IMF Data
*Data Lab: OECD
*CIA FactBook
...
df_FitchReduced_Summary <- summary(df_Fitch_Reduced)
