...
map_z <- z %>%
  ...
  joinCountryData2Map( joinCode = "ISO3" ,nameJoinColumn = "Country Code")
mapParamsj <- mapCountryData(map_z ,nameColumnToPlot='Junk Bond Status', addLegend=FALSE ) 
...
```
Now the distortion around BB has disappeared


```{r echo=FALSE, message=FALSE, warning=FALSE}
gg_CreditReduced
gg_CreditReducedLetter

```

The above two diagrams show the distribution of the data minus missingness.  The irony is the AA rated countries share less data openly.
...
There is a clear divide around the world between South America, Africa, Asia Mnor and the former USSR compared to North America, Western Europe and Australiasia. With the former largerly considered non investment grade (Junk). Without access low yeild bonds (cheap finance) how do these countries fund capital expenditures to develop? 
